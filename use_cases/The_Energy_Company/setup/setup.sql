...
CREATE OR REPLACE STAGE CONTRACTS 
...
COPY FILES
  INTO @CONTRACTS
  FROM @AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS_JOJRG/branches/energy_company_enhancements/use_cases/The_Energy_Company/docs/;
ALTER STAGE CONTRACTS REFRESH;

-- Create Notebooks
CREATE NOTEBOOK SI_ENERGY_COMPANY
    FROM '@AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS_JOJRG/branches/energy_company_enhancements/use_cases/The_Energy_Company' 
