...
COPY FILES
  INTO @CUSTOM_TOOLS
  FROM @GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS_JOJRG/branches/energy_company_enhancements/custom_tools/;
...
GRANT ROLE AI_ENGINEER to ROLE ACCOUNTADMIN;
...
GRANT READ ON GIT REPOSITORY GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS_JOJRG TO ROLE AI_ENGINEER;

-- Setup Custom Tools for Agents
EXECUTE IMMEDIATE FROM @AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS_JOJRG/branches/energy_company_enhancements/setup/setup_custom_tools.sql;

-- Setup Apps
EXECUTE IMMEDIATE FROM @AI_DEVELOPMENT.PUBLIC.GITHUB_REPO_SNOWFLAKE_INTELLIGENCE_DEMOS_JOJRG/branches/energy_company_enhancements/setup/setup_apps.sql;
